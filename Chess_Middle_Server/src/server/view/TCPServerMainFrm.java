...
import server.control.TCPServerCtr;
 
public class TCPServerMainFrm extends JFrame implements ActionListener{
    private JTextField txtServerHost, txtServerPort;
    private JButton btnStartServer, btnStopServer;  
    private JTextArea mainText;
    private TCPServerCtr myServer;
    //private SimpleServerCtr myServer;
     
    public TCPServerMainFrm(){
...
//                    myServer = new TCPServerCtr(this, port);
                }else {// default port
                    myServer = new TCPServerCtr(this);
                }
    ...
    public static void main(String[] args) {
        TCPServerMainFrm view = new TCPServerMainFrm();
